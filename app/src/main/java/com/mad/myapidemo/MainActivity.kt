...
import com.mad.myapidemo.api.RetrofitInstance
            ...
            call.enqueue(object: Callback<List<StudentRespond>> {
                ...
                override fun onResponse(
                    ...
                    for(student : StudentRespond in rs!!){
                        nameList += " id: ${student.id}  name: ${student.name}\n"

                    }


                    findViewById<TextView>(R.id.tvResult).text = nameList
                }
